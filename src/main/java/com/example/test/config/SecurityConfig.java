    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        // Public endpoints
                        .requestMatchers("/api/auth/login", "/api/auth/logout", "/api/auth/forgot-password", "/deeplink/**", "/.well-known/assetlinks.json","api/auth/**","/api/job-rotations/assign-vehicle").permitAll()
